...
exports.register = function(server, options, next) {
    ...
    server.route({
        ...
        config: {
            tags: ['api', 'auth'],
            notes: 'Expects base64 encoded username/password in payload',
    ...
    server.route({
        ...
        config: {
            tags: ['api', 'auth'],
            notes: 'Auth signature required. Must match key provided in url',
            description: 'Remove API key from auth DB',
