...
function parseCookie(cookieValue, hawkKeyStore) {
     ...
     * This is designed to be the input to a Promise constructor
    ...
    if (
        ...
        return Promise.reject(new Error('Invalid keyStore passed'));
    }

    // The JWT library throws errors, will catch them and pass them as a promise
    return new Promise(jwtVerifyAsPromised)
        .then((parsedJwt) => {
