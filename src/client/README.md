...
Much of the source code for the javascript client is generated by swagger-codegen during the build process (`npm run-script build`).

To re-generate the client separately from the build, run `npm run-script generate-client`.
